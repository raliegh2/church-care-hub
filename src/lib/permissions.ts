...
export const canManageAttendance = (role: AppRole) => role === 'usher' || role === 'pastor' || role === 'administrator';
export const canManageVisitors = canManageAttendance;
...
export function roleResponsibility(role: AppRole): string {
  if (role === 'usher') return 'Visitor care and attendance';
